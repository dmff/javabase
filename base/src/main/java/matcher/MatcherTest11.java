 ...
 * 正则表达式测试
 */
public class MatcherTest11 {

    @Test
    public void test1(){
        /**
         * 使用string类自带的matches和splits，.代表任意字符
         *
         ...
         */
        String str1 = "abcdefd003fdfd103".replaceAll("\\d", "");
        System.out.println(str1);

        String str2 = "abcdefg003fdfd133".replaceAll("\\D", "8");
        System.out.println(str2);

        String str3 = "abcdefd003fdfd103".replaceAll("fd|03", "");
    ...
    public void test2(){
        ...
        boolean b1 = "efKJ".matches("[d-gH-O]{4}");
        System.out.println(b1);

        //[0-9]，数字字符，但是也可以用[5-8]这样的写法
        boolean b2 = "678".matches("[5-9]{3}");
        System.out.println(b2);

        //[a-zA-Z_0-9]等价于\\w，但是很多时候，我们想缩短一些距离，比如[d-gH-O_5-8]
        boolean b3 = "efJK678".matches("[d-gH-O_5-9]*");
        System.out.println(b3);

        //可是有些时候想表达a-e和h-j这样的区间，写法是[a-e[h-j]]和[a-eh-j]一样的效果，是并集
        boolean b4 = "acij".matches("[a-ci-j]*");
    ...
    public void test3(){
        ...
        Matcher matcher = pattern.matcher("asbdb");
    ...
    public void test5(){
        ...
        //将所有符合pattern的都替换成小写java，这个写法真的是高明啊！
        String newString = str.replaceAll("[Jj][Aa][Vv][Aa]", "java");
        System.out.println(newString);

        Pattern pattern = Pattern.compile("java",Pattern.CASE_INSENSITIVE);
        Matcher m = pattern.matcher(str);
        String newString2 = m.replaceAll("java");
        ...
        Matcher m1 = pattern1.matcher("fdfdgjdgjdgj  ggaggAGFGFGFHFHH");
        System.out.println(m1.matches());

        Pattern pattern2 = Pattern.compile("(?i)abc(?-i)abc");
        Matcher m2 = pattern2.matcher("ABCabc");
        System.out.println(m2.matches());
         ...
         * 启动多行模式，会对^和$有行的影响。
         */
        Pattern pattern5 = Pattern.compile("^java", Pattern.MULTILINE);
        Matcher m5= pattern5.matcher("dfjkdjfdj" + System.getProperty("line.separator") +
                "javafjddkj" + System.getProperty("line.separator") + "javaefrjkrjt");
        while (m5.find()){
