...
public class TrieTree {
	...
	public static void main(String[] args) throws IOException{
		/*
		 * TrieTree tree = new TrieTree(); String[] strs = { "banana", "band",
		 * "bee", "absolute", "acm", }; String[] prefix = { "ba", "b", "band",
		 * "abc", }; for (String str : strs) { tree.insert(str); }
		 * System.out.println(tree.has("abc"));
		 * tree.preTraverse(tree.getRoot()); System.out.println(); //
		 * tree.printAllWords(); for (String pre : prefix) { int num =
		 * tree.countPrefix(pre); System.out.println(pre + "数量:" + num); }
		 */
